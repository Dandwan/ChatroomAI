...
| D1 useConversation | ❌ 未做 | — | ~500 | 对话 CRUD/水合/保存 |
| D3 useSettings | ❌ 未做 | — | ~400 | 设置变更/provider 配置 |
| D4 useExtensions | ❌ 未做 | — | ~200 | skill/runtime 管理 |
| D5 useUpdates | ❌ 未做 | — | ~100 | 应用更新检查 |
| D6 usePermissions | ❌ 未做 | — | ~80 | 权限开关 |
| E views | ❌ 未做 | — | ~1,500 | 渲染函数提取 |
| F polish | ❌ 未做 | — | ~200 | 最终精简 |
| **目标** | — | **~400** | **−7,176 (−94.7%)** | |
